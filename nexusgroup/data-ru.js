...
window.WHEEL_PRIZES = [
  { t: "Мастер-класс",            d: "Элитная онлайн-сессия по финансовому мышлению" },
  { t: "0% ипотека",              d: "План рефинансирования и компенсации ставок через инвестиции" },
  { t: "Самоокупаемая ипотека",   d: "Сценарий, когда ваш пассивный доход перекрывает выплаты" },
  { t: "Обучение анализу",        d: "Быстрый старт в техническом и фундаментальном анализе" },
  { t: "Выход из ямы",            d: "Пошаговый антикризисный план с сопровождением" },
  { t: "Личный финплан",          d: "Индивидуальная схема достижения целей с Excel-шаблоном" },
  { t: "Стратегия 2x/6 мес",      d: "Доказанная модель удвоения капитала на волатильных активах" },
  { t: "Звонок наставнику",       d: "Консультация 1-на-1 по вашим финансам" },
  { t: "Чат инвесторов",          d: "Приватный Telegram-канал с сигналами и аналитикой" },
  { t: "Аудит крипты",            d: "Разбор портфеля, рекомендации по безопасности и росту" },
  { t: "Психология денег",        d: "Мини-курс по ментальным барьерам и привычкам инвестора" },
  { t: "Инвест-трекер",           d: "Готовый шаблон учёта и анализа сделок" },
  { t: "План свободы",            d: "5-летняя дорожная карта к финансовой независимости" },
  { t: "3 инструмента защиты",    d: "Как не потерять при падении рынка" },
  { t: "Ресурсы обучения",        d: "Подборка книг, видео и курсов от экспертов" },
  { t: "10 ошибок",               d: "Что не стоит делать на рынке в 2025 году" },
  { t: "Бюджет новичка",          d: "Методика 60-20-20 с шаблоном" },
  { t: "Выбор брокера",           d: "Сравнение популярных платформ и подводных камней" },
  { t: "Упс... почти!",           d: "Попробуйте снова через 24 часа" },
  { t: "Бонус в Telegram",        d: "Подарок — по коду «колесо» в наш Telegram-бот" }
];
